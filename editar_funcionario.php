...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <h2 class="ls-title-3 ls-ico-edit-admin">Editar - Funcionário</h2>
  </header>
...
$total = mysqli_num_rows($dados);
  ...
  <form action="include/Ufunc.php" method="post" class="ls-form ls-form-horizontal" data-ls-module="form">
  <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">
    ...
    <label class="ls-label col-md-3">
      ...
      <input type="text" name="endereco" id="sobrenome" class="ls-field" value=<?=$linha['endereco']?> required >
    </label>
    ...
    <label class="ls-label col-md-2">
      ...
      <input type="text" name="dataNascimento" id="dataNascimento" class="datepicker" value=<?=$linha['dataNascimento']?> ><br><br><br><br>
    </label>
