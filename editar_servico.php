...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <h2 class="ls-title-3 ls-ico-user-add">Editar - Serviço</h2>
  </header>
...
$total = mysqli_num_rows($dados);
  ...
  <form action="include/Userv.php" method="post" class="ls-form-horizontal" data-ls-module="form">
  <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">

    <label class="ls-label col-md-3">
      <b class="ls-label-text">Serviço</b>      
      <input type="text" name="servico" id="servico" value=<?=$linha['tipoServico']?> required >
    </label>

    <label class="ls-label col-md-3">
      <b class="ls-label-text">Data de Vencimento</b>      
      <input type="text" class="datepicker" name="data" id="data" value=<?=$linha['dataVencimento']?> required >
    </label>

    <label class="ls-label col-md-2">
      <b class="ls-label-text">Valor</b>
      <input type="text" id="valor" name="valor" value=<?=$linha['valor']?> required >
    </label>

    <label class="ls-label col-md-2">
      <b class="ls-label-text">Cliente</b>
      <input type="text" id="cliente" name="cliente" value=<?=$linha['cliente']?> required >
    </label>

    <input type="hidden" name="idServico" value=<?=$linha['idServico']?>>
