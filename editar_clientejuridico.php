...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <h2 class="ls-title-3 ls-ico-edit-admin">Editar - Pessoa Jurídica</h2>
  </header>
...
$total = mysqli_num_rows($dados);
  ...
  <form action="include/Ucj.php" method="post" class="ls-form ls-form-horizontal" data-ls-module="form">
  <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">

  <label class="ls-label col-md-3">
      <b class="ls-label-text">Razão Social</b>      
      <input type="text" name="razaoSocial" id="razaoSocial" value=<?=$linha['razaoSocial']?> required>
    </label>
    ...
    <label class="ls-label col-md-3">
      ...
      <input type="text" name="cnpj" id="cnpj" value=<?=$linha['cnpj']?> required >
    </label>
...
<div class="ls-actions-btn">
    <a href="clientejuridico.php"><button class="ls-btn ls-ico-chevron-left">Voltar</button></a>
  </div>
    </main>
