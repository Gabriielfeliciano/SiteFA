...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <h2 class="ls-title-3 ls-ico-user-add">Editar - Tipo de Serviço</h2>
  </header>
...
$total = mysqli_num_rows($dados);
  ...
  <form action="include/Utiposerv.php" method="post" class="ls-form-horizontal" data-ls-module="form">
  <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">

    <label class="ls-label col-md-3">
      <b class="ls-label-text">Serviço</b>      
      <input type="text" name="servico" id="servico" value=<?=$linha['servico']?> required >
    </label>

    <label class="ls-label col-md-3">
      <b class="ls-label-text">Fornecedor</b>      
      <input type="text" name="fornecedor" id="fornecedor" value=<?=$linha['fornecedor']?> required >
    </label>

    <label class="ls-label col-md-2">
      <b class="ls-label-text">Descrição</b>
      <input type="text" id="descricao" name="descricao" value=<?=$linha['descricao']?> required >
    </label>

    <input type="hidden" name="idServicos" value=<?=$linha['idServicos']?>>
