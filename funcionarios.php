...
$(document).ready(function() {
  ...
  <header class="ls-info-header">
    <!--icone no titulo -->
    <h2 class="ls-title-3 ls-ico-tree">Funcionários</h2>
    <a href="cadastro_funcionario.php" class="ls-btn ">Adicionar Funcionario</a>
  </header>
...
<table  class="ls-table ls-table-striped display" id="tabela" style="width:100%">
  <thead>
    <tr>
      ...
      <th class="hidden-xs ls-data-descending">Setor</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="hidden-xs"><?=$linha['nome']?></td>
      ...
      <td>
        ...
        <form action="visualizar_funcionario.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden" name="idFuncionario" id="idFuncionario" value=<?=$linha['idFuncionario']?>> 
        <button type="submit" class="ls-btn ls-ico-eye espacobtn" title="Ver"></button>
        </form>
        <form action="editar_funcionario.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden" name="idFuncionario" id="idFuncionario" value=<?=$linha['idFuncionario']?>>
        <button  type="submit" class="ls-btn ls-ico-pencil espacobtn" title="Visualizar informações"></button>
        </form>
        <form action="include/Dfunc.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden"name="idFuncionario" id="idFuncionario" value=<?=$linha['idFuncionario']?>>
...
<?php } else {
  ...
  <span data-ls-module="dismiss" class="ls-dismiss" >&times;</span>
              Você não é autorizado a entrar nesta pagina.
  </div>';
