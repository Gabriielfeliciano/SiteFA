...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <h2 class="ls-title-3 ls-ico-user-add">Cadastro - Pessoa Jurídica</h2>
  </header>
...
<div>
  ...
  <form action="include/Ccj.php" method="post" class="ls-form-horizontal">
  <fieldset>

    <label class="ls-label col-md-3">
      <b class="ls-label-text">Razão Social</b>      
      <input type="text" name="razaoSocial" id="razaoSocial" placeholder="Ubireudo" required >
    </label>
