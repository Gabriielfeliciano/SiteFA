...
$(document).ready(function() {
  ...
  <header class="ls-info-header">
    ...
    <a href="cadastro_relatorio_func.php" class="ls-btn ">Adicionar Relatorio</a>
  </header>
  ...
  <tbody>
    ...
    <tr>
      <?php
        ...
        include "include/Rrelatorio_func.php";
      ...
      <td>
        ...
        <form action="include/Drelatorio_func.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden" name="idRelatoriofunc" id="idRelatoriofunc" value=<?=$linha['idRelatoriofunc']?>> 
