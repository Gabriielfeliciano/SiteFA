...
$idperfil = $_SESSION['idAdministrador'];

// cria a instrução SQL que vai selecionar os dados
$query = sprintf("SELECT  * FROM administrador WHERE idAdministrador = $idperfil");
//echo $query;
...
$total = mysqli_num_rows($dados);
  ...
  <div class="form">
    <form action="include/UperfilAdm.php" method="post" class="ls-form-horizontal " data-ls-module="form">
      <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">

        <label class="ls-label col-md-4">
          <b class="ls-label-text">Nome da Empresa</b>      
          <input type="text" name="nomeEmpresa" id="nomeEmpresa" value=<?=$linha['nomeEmpresa']?>>
        </label>
